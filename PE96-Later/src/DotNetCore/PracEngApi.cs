...
namespace ConsoleApp1
{
    public class PracEngApi
    {
        ...
        /// <summary>
        /// Builds the Client to access the Apis after getting an AuthorizationToken and Refreshing when necessary
        /// </summary>
        /// <returns>A Client with a valid Authentication Token Set</returns>
        private async Task<HttpClient> GetClient()
        {
            ...
            if (!tokenResponse.IsError)
            {
                ...
                Console.WriteLine($"Token expires after {tokenResponse.ExpiresIn} seconds");
        ...
        /// <summary>
        /// Performs a GET to an API Method
        /// </summary>
